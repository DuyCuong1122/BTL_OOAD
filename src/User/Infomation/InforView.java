...
//		nhomMau();
	...
	public void HoVaTen(String id)
	{
		...
		JLabel lb_name = new JLabel(InforController.getInstance(id).name());
	...
	public void birthday(String id) {
		...
		JLabel lb_ngaySinh = new JLabel(InforController.getInstance(id).ngaySinh());
	...
	public void SDT(String id) {
		...
		JLabel lb_sdt = new JLabel(InforController.getInstance(id).sdt());
	...
	public void diaChi(String id) {
		...
		JLabel lb_diaChi = new JLabel(InforController.getInstance(id).diaChi());
	...
	public void CCCD(String id) {
		...
		JLabel lb_CCCD = new JLabel(InforController.getInstance(id).CCCD());
	...
	public void ngheNghiep(String id) {
		...
		JLabel lb_ngheNghiep = new JLabel(InforController.getInstance(id).ngheNghiep());
	...
	public void noiCongTac(String id) {
		...
		JLabel lb_noiCongTac = new JLabel(InforController.getInstance(id).noiCongTac());
	...
	public void nhomMau(String id) {
		...
		JLabel lb_nhomMau = new JLabel(InforController.getInstance(id).nhomMau());
