...
public class Info_eventView extends JPanel {
	...
	public void button_chinhSua() {
		JButton bt_thamGia = new JButton("Chỉnh sửa");
		...
		bt_thamGia.addActionListener(new ActionListener() {
			@Override
			public void actionPerformed(java.awt.event.ActionEvent e) {
				System.out.println("Button 'Change' clicked");
				JOptionPane.showMessageDialog(null, "Chỉnh sửa sự kiện thành công");
			}
		});
	}
