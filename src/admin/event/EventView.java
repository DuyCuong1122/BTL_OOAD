...
public class EventView extends JPanel {
    public EventView() {
        ...
        JButton bt_add = new JButton("Thêm sự kiện");
        bt_add.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
                // Xử lý sự kiện khi nút "Quay lại" được nhấn
                System.out.println("Button 'Add event' clicked");
                EventController.getInstance().showAddEvent();
            }
        });
        ...
        for (int i = 1; i <= 40; i++) {
            ...
            button.addActionListener(new ActionListener() {
                ...
                public void actionPerformed(ActionEvent e) {
                    ...
                    EventController.getInstance().showInfoEvent();
                }
            });
